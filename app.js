//injecting ionic library into my app
//angular.module('app', ['ionic'])
//one way to do a controller, semi colon removed from above when adding controller
//.controller("lets-build", function($scope){
    //var invisible = "can't see this";
    //$scope.visibleVariable = "I can see you";
//});
//$scope.items = [{"value1", "value2"}]
//second way to do controller
//var myApp = angular.module('app',['ionic']);
//myApp.controller("name", function($scope){
    
//});
/* globals angular */
// --NOTES ABOVE THIS LINE -- Ionic Starter App
